...
def build_actions() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "success_metric": "Track whether performance stabilizes versus baseline over the next review window",
        ...
        },
        {
            ...
            "priority": "high",
            "action_type": "escalate",
            "success_metric": "Monitor trend direction and consistency across upcoming shifts",
